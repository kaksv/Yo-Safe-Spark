          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gradient-flare">Yo Safe</h1>
                  <p className="text-sm text-gray-600 font-medium">A spark • to steady and secure • Savings</p>
                </div>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <div className="inline-flex items-center space-x-2 bg-flare-gradient-light px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-flare-700 font-semibold text-sm">Powered by Spark:: Save: lend: earn liquidity</span>
          </div>
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Secure Spark and Sky <span className="text-gradient-flare">Vaults</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
           We save your assets by turning them into yield bearing assets. 
           Using spark and its liquidity layer. Access your liquidity whenever you need them.
          </p>
          ...
          <div className="stats-card mb-12 animate-slide-up">
            <div className="text-center">
              <div className="inline-flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-700">Your Saved Eth Balances</h3>
              </div>
              <div className="text-4xl font-bold text-gradient-flare mb-2">
                {Number(formatEther(Stake)).toFixed(3)} ETH
              </div>
        ...
        <footer className="text-center py-12 border-t border-flare-200/30 mt-20">
          <div className="max-w-md mx-auto">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-gradient-flare">YO-Safe</span>
            </div>
            <p className="text-gray-600 mb-6">
              Built with ❤️ for the <span className="font-bold">SPARK Community</span>
            </p>
          </div>
        </footer>
      </main>
