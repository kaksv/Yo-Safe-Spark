    ...
    return (
      <div className="flare-card p-8 text-center animate-fade-in">
        ...
        <p className="text-gray-600 mb-8 text-lg">
          Connect your wallet to start earning rewards on Spark
        </p>
        <button
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-orange-700 text-sm mt-1">
                Please Ensure you are connected to the Base Mainnet.
              </p>
            </div>
          </div>
          <button
    ...
    <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-6 animate-slide-up">
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <p className="text-green-700 text-sm font-semibold">Base</p>
          <p className="text-green-600 text-xs">Mainnet</p>
        </div>
      </div>
    </div>
  );
